Pod::Spec.new do |s|
  ...
  s.platform     = :ios, "8.0"
  s.source       = { :http => "https://github.com/yieldmo/sdk-beta/archive/beta-8.zip" }
  s.preserve_paths = "sdk-beta-beta-8"
  s.vendored_frameworks = "sdk-beta-beta-8/iOS/Yieldmo.framework"
  s.resources = "sdk-beta-beta-8/iOS/Yieldmo.bundle"
